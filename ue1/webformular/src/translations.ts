...
export const translations: Record<Sprache, Record<string, string>> = {
  de: {
    ...
    "form.hint.bic": "Vom PDF-Antrag als Pflichtfeld vorgesehen.",
  ...
  it: {
    ...
    "form.hint.bic": "Campo obbligatorio previsto dal modulo PDF.",
  ...
  tr: {
    ...
    "form.hint.bic": "PDF başvurusunda zorunlu alan olarak öngörülmüştür.",
  ...
  es: {
    ...
    "form.hint.bic": "Campo obligatorio previsto en el formulario PDF.",
