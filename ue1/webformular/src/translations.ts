...
export const translations: Record<Sprache, Record<string, string>> = {
  de: {
    ...
    "stepper.5.titel": "Kosten",
    "stepper.6.titel": "Anlage",
  ...
  it: {
    ...
    "stepper.5.titel": "Costi",
    "stepper.6.titel": "Allegato",
  ...
  es: {
    ...
    "stepper.5.titel": "Costes",
    "stepper.6.titel": "Anexo",
