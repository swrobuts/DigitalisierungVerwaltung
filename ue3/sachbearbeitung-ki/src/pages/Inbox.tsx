/**
 * UE3 Inbox — Multi-FB-Sicht auf `apl.antrag_inbox`.
 *
 * Identisch zu UE2 plus zwei UE3-only-Erweiterungen:
 *   - Header-Nav: „Smart Upload" + „Compliance"
 *   - KI-Bescheid-Generierung liegt auf der Detail-Seite
 *
        ...
        <div className="w-full px-4 py-3 flex items-center justify-between gap-6">
          <div>
            ...
            <h1 className="text-xl font-bold leading-tight">
              Sachbearbeitung — APL (KI-Variante)
            </h1>
